...
//        }
    ...
    /**
     * 向 Map 中添加 signType、paySign <br>
     * 适用于前端H5发起请求，封装数据
     * @param signData
     * @return
     * @throws Exception
     */
    public Map<String, String> generateSignatureMap(Map<String, String> signData) throws Exception{
    	if (SignType.MD5.equals(this.signType)) {
    		signData.put("signType", WXPayConstants.MD5);
        }
        else if (SignType.HMACSHA256.equals(this.signType)) {
        	signData.put("signType", WXPayConstants.HMACSHA256);
        }
    	signData.put("paySign", WXPayUtil.generateSignature(signData, config.getKey(), this.signType));
    	return signData;
    }
